...
public class ReleaseCanarySingleStreamCompatiblePollingH2TestConfig extends KCLAppConfig {
    ...
    public StreamTracker getStreamTracker(Map<Arn, Arn> streamToConsumerArnsMap) {
        ...
        return new SingleStreamCompatibleTracker(streamIdentifier, streamConfig);
    }
